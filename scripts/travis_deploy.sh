...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "hvdinh16/iRhto_memote" ]]; then
...
echo "Your new report will be visible at https://hvdinh16.github.io/iRhto_memote in a moment."
