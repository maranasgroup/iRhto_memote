...
Edit the model so that it uses the correct xylose assimilation pathway (from Jagtap et al., 2021, pmid:34491401). Change GPR of arabitol dehydrogenase from UNKNOWN to ARD1.
